...
1. Run the appropriate command for your OS:
   ...
   *macOS/Linux*
   ...
   ```bash
   docker run -v .:/mnt/${PWD##*/} -w /mnt/${PWD##*/} -v ~/.gitconfig:/root/.gitconfig:ro -it --pull always --rm ghcr.io/natescherer/postmodern-tools-container:latest copier copy --trust gh:natescherer/postmodern-docker-container-copiertemplate .
   ```
